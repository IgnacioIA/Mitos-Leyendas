...
// se deja con el nombre de la página porque no es contenido narrativo, solo
// identifica la sección; el resto queda vacío a la espera del texto real.
const dataDominiosDeRaPaginaLoreHero = {
  tituloTop: "RELATOS DE",

  tituloMain: "DOMINIOS DE RA",
